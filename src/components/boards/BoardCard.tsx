...
export default function BoardCard() {
    return (
        <div className="max-w-[350px] w-full bg-light-purple rounded-lg px-6 py-3 my-8 mr-4">
            <h2 className="text-xl font-bold text-dark-purple">Mobile App Design</h2>
            <p className="font-medium my-2">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum eaque magnam facere voluptas numquam voluptate cum vel consequuntur reprehenderit alias.</p>
